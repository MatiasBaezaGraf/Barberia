...
class BarbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barber" do
    assert_difference('Barber.count') do
      post barbers_url, params: { barber: { first_name: @barber.first_name, last_name: @barber.last_name } }
    end
  ...
  test "should update barber" do
    patch barber_url(@barber), params: { barber: { first_name: @barber.first_name, last_name: @barber.last_name } }
